...
We can also use the same kind of approach to compare within a group the difference between two timepoints, or between two groups the difference in timepoints. 

```{r}
preDiffContrasts <- create_timepoints_contrasts(
    moaninObject, "Postflowering", "Control" ,type="per_group_timepoint_diff")
...
preGroupDiffContrasts <- create_timepoints_contrasts(
    moaninObject, "Postflowering", "Control" ,type="group_and_timepoint_diff")
